# Excersies for Chapter 3 of "Introduction to Programming using Python"
...
area_1 = math.sqrt(s_1 * (s_1 - dist_atl_char) * (s_1 - dist_char_sav) * (s_1 - dist_sav_atl))
# Triangle 2:
s_2 = (dist_sav_orl + dist_orl_atl + dist_sav_atl)/2
area_2 = math.sqrt(s_2 * (s_2 - dist_sav_orl) * (s_2 - dist_orl_atl) * (s_2 - dist_sav_atl))
final_area = area_1 + area_2
print("The area encompassed by the four cities is", round(final_area, 2), "square km!")
