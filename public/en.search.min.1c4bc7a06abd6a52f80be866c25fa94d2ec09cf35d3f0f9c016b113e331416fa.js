...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~ves314/flexsearch.min.js');loadScript('/~ves314/en.search-data.min.fa88035ea5a23a14013429dc52a76cc90a1f507945628d8a9bd4cdbbb560bca3.js',function(){input.required=false;search();});}
