...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~ves314/flexsearch.min.js');loadScript('/~ves314/en.search-data.min.6ee9605f94f0b00a6788a7699b08233a69f149d6789853a0bcfa77aa3fd41197.js',function(){input.required=false;search();});}
