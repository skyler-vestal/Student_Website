...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~ves314/flexsearch.min.js');loadScript('/~ves314/en.search-data.min.4b3246a967a411e5281fc2103880a927ef4a7ff429531eb03f4fb87f12eb2185.js',function(){input.required=false;search();});}
