...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~ves314/flexsearch.min.js');loadScript('/~ves314/en.search-data.min.db7566a0aaa9453f98229a16035c4a887e855834bd5d1e2bf133af12da9136db.js',function(){input.required=false;search();});}
